...
import { Payroll, UpdatePayrollData } from "@modules/payroll/payroll.types.js";
import {
  EMPLOYEE_TABLE,
  PAYROLLS_TABLE,
  POSITION_TABLE,
} from "@common/constants/database.js";
import { getTotalWorkDays } from "@modules/attendances/attendance.model.js";
import {
  getTotalDeductionAmount,
  getTotalLeaveDays,
} from "@modules/leave-requests/leave-request.model.js";
